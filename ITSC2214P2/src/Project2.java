...
/**
 * Driver for Project 2 for the Spring 2024 of the ITSC 2214 Course.
 * 
...
/**
 * The project2 class serves as main entry point for program
 * Processes the input text files to calculate word frequencies using hashWords
 */
public class Project2 {
    /**
     * Default constructor for project2 class
     * Init purposes
     */
    public Project2(){
        //any initializations needed
    }
    /**
